/**
 * Session title generation via Electron.
 *
 ...
 * all surfaces. Previously there were separate Electron title generators:
...
/**
 * Flatten a message array into a single text string for Electron title input.
 ...
 * Returns null on error or if Electron returns an unparseable response.
 *
