...
/**
 * Check if a file is a Nexus-managed memory file (NOT user-managed instruction files).
 * Includes: auto-memory (memdir), agent memory, session memory/transcripts.
 * Excludes: NEXUS.md, NEXUS.local.md, .claude/rules/*.md (user-managed).
 *
...
// Excludes NEXUS.md, NEXUS.local.md, .claude/rules/ (user-managed).
