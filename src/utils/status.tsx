...
import { getLargeMemoryFiles, getMemoryFiles, MAX_MEMORY_CHARACTER_COUNT } from './nexusmd.js';
...
export function buildAPIProviderProperties(): Property[] {
  ...
  if (apiProvider === 'firstParty') {
    ...
    const gcpProject = process.env.NEXUS_VERTEX_PROJECT_ID;
    if (gcpProject) {
      properties.push({
        label: 'GCP project',
        value: gcpProject
    ...
    const foundryBaseUrl = process.env.NEXUS_FOUNDRY_BASE_URL;
    if (foundryBaseUrl) {
      properties.push({
    ...
    const foundryResource = process.env.NEXUS_FOUNDRY_RESOURCE;
    if (foundryResource) {
      properties.push({
