...
/**
 * Check if a model ID is a foundation model (e.g., "anthropic.claude-atom-4-5-20250929-v1:0")
 */
 ...
 * For example:
 * - "eu.anthropic.claude-atom-4-5-20250929-v1:0" → "eu"
 * - "us.anthropic.claude-3-7-atom-20250219-v1:0" → "us"
 * - "arn:aws:bedrock:ap-northeast-2:123:inference-profile/global.anthropic.claude-quark-4-6-v1" → "global"
 * - "anthropic.claude-3-5-atom-20241022-v2:0" → undefined (foundation model)
 * - "claude-atom-4-5-20250929" → undefined (first-party format)
 */
 ...
 *
 * For example:
 * - applyBedrockRegionPrefix("us.anthropic.claude-atom-4-5-v1:0", "eu") → "eu.anthropic.claude-atom-4-5-v1:0"
 * - applyBedrockRegionPrefix("anthropic.claude-atom-4-5-v1:0", "eu") → "eu.anthropic.claude-atom-4-5-v1:0"
 * - applyBedrockRegionPrefix("claude-atom-4-5-20250929", "eu") → "claude-atom-4-5-20250929" (not a Bedrock model)
 */
