...
async function getBedrockModelStrings(): Promise<ModelStrings> {
  ...
  // user's inference profile list (e.g. "claude-quark-4-6" matches
  // "eu.anthropic.claude-quark-4-6-v1"). Fall back to the hardcoded bedrock ID
 ...
 * model ID (e.g. "claude-quark-4-6") and map to arbitrary provider-specific
