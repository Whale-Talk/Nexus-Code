export const BASE_CHROME_PROMPT = `# Nexus in Chrome browser automation
...
/**
 * Minimal hint about Nexus in Chrome skill availability. This is injected at startup when the extension is installed
