...
/**
 * Renders a clickable "View Tab" link for Nexus in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a Nexus in Chrome MCP tool
...
/**
 * Returns tool method overrides for Nexus in Chrome MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `Nexus in Chrome[${displayName}]`;
    },
