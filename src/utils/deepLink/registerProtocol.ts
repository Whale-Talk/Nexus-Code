...
const APP_NAME = 'Nexus Code URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Nexus Code URL Handler.app'
 ...
 * Nexus then uses the url-handler NAPI module to read the URL from the
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Nexus Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Nexus Code
