...
/**
 * Captured at module load time to detect if the user started Nexus from within tmux.
 ...
 * because Shell.ts overrides TMUX when Nexus's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started Nexus from within their tmux session
