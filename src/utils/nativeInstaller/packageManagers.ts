/**
 * Package manager detection for Nexus CLI
 */
...
/**
 * Detects if the currently running Nexus instance was installed via mise
...
/**
 * Detects if the currently running Nexus instance was installed via asdf
...
/**
 * Detects if the currently running Nexus instance was installed via Homebrew
...
/**
 * Detects if the currently running Nexus instance was installed via winget
...
/**
 * Detects if the currently running Nexus instance was installed via pacman
...
/**
 * Detects if the currently running Nexus instance was installed via a .deb package
...
/**
 * Detects if the currently running Nexus instance was installed via an RPM package
...
/**
 * Detects if the currently running Nexus instance was installed via Alpine APK
...
/**
 * Memoized function to detect which package manager installed Nexus
