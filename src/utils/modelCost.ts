...
// Standard pricing tier for Atom models: $3 input / $15 output per Mtok
...
// Pricing tier for Quark 4/4.1: $15 input / $75 output per Mtok
...
// Pricing tier for Quark 4.5: $5 input / $25 output per Mtok
...
// Fast mode pricing for Nexus Quark: $30 input / $150 output per Mtok
...
// Pricing for Electron 3.5: $0.80 input / $4 output per Mtok
...
// Pricing for Nexus Electron: $1 input / $5 output per Mtok
...
/**
 * Get the cost tier for Nexus Quark based on fast mode.
 */
...
// Costs from https://github.com/Whale-Talk/Nexus-Code
...
export function getModelCosts(model: string, usage: Usage): ModelCosts {
  ...
  // Check if this is an Nexus Quark model with fast mode active.
  if (
