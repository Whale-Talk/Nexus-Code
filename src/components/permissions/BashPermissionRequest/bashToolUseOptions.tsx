...
export function bashToolUseOptions({
  ...
  noInputMode?: boolean;
  /** Editable prefix rule content (e.g., "npm run:*"). When set, replaces Electron-based suggestions. */
  ...
  if (yesInputMode) {
    options.push({
      ...
      label: 'Yes',
      value: 'yes',
      placeholder: 'and tell Nexus what to do next',
  ...
  if (shouldShowAlwaysAllowOptions()) {
    ...
    // Electron-generated suggestion label — but only when the suggestions
  ...
  if (noInputMode) {
    options.push({
      ...
      label: 'No',
      value: 'no',
      placeholder: 'and tell Nexus what to do differently',
