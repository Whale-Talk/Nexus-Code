 ...
 * users think of as "a new message from Nexus" — not raw assistant entries
 ...
 * until Nexus's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what Nexus was
