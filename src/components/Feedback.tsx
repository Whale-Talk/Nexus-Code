...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/Whale-Talk/Nexus-Code' : 'https://github.com/Whale-Talk/Nexus-Code';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Nexus Code&apos;s functionality (eg. to reduce the risk of bugs
