    ...
    case "thinking":
      {
        ...
        const thinkIdx = parseInt(thinkingBlockId?.split(':').pop() ?? '0');
        const isLastBlock = contentLength != null && thinkIdx === contentLength - 1;
