...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between Claude models. Applies to this session and future Nexus Code sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
