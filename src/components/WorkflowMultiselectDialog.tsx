...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@Nexus Code - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'Nexus Code Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/Whale-Talk/Nexus-Code">https://github.com/Whale-Talk/Nexus-Code</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
