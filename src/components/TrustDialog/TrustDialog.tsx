...
export function TrustDialog(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t17 = <Text>快速安全检查：这是您创建或信任的项目吗？（例如您自己的代码、知名的开源项目或团队的工作）。如果不是，请先花点时间检查此文件夹中的内容。</Text>;
    t18 = <Text>Nexus Code 将能够在此处读取、编辑和执行文件。</Text>;
    $[20] = t16;
    $[21] = t17;
    $[22] = t18;
  } else {
  ...
  if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
    t19 = <Text dimColor={true}><Link url="https://github.com/Whale-Talk/Nexus-Code">安全指南</Link></Text>;
    $[23] = t19;
  } else {
    t19 = $[23];
  }
