...
**All verifier skills are created in the project root's \`.nexus/skills/\` directory.** This ensures they are automatically loaded when Nexus runs in the project.
