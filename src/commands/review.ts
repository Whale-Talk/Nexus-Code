...
// user triggers, so the description carries "Nexus Code on the web" + URL.
const CCR_TERMS_URL = 'https://github.com/Whale-Talk/Nexus-Code'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Nexus Code on the web. See ${CCR_TERMS_URL}`,
