...
/**
 * Map LSP severity to Nexus diagnostic severity
 *
 * Maps LSP severity numbers to Nexus diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Nexus diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Nexus's attachment system.
 */
 ...
 * from all LSP servers and routes them to Nexus's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Nexus format (can throw on invalid URIs)
