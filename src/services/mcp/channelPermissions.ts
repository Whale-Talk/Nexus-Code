 ...
 *
 * Kenneth's "would this let Nexus self-approve?": the approving party is
 * the human via the channel, not Nexus. But the trust boundary isn't the
 ...
 * module-level (per src/NEXUS.md), NOT in AppState (functions-in-state
