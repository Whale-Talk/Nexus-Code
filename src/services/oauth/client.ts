// OAuth client for handling authentication flows with Nexus services
...
export function buildAuthUrl({
  ...
  authUrl.searchParams.append('code', 'true') // this tells the login page to show Nexus Max upsell
