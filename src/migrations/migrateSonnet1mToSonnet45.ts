 ...
 *
 * The "sonnet" alias now resolves to Nexus Atom, so users who previously set
 * "sonnet[1m]" (targeting Sonnet 4.5 with 1M context) need to be pinned to the
 * explicit version to preserve their intended model.
 *
 * This is needed because Nexus Atom 1M was offered to a different group of users than
