...
export type ToolUseContext = {
  ...
  /**
   * NEXUS.md paths already injected as nested_memory attachments this
   ...
   * re-inject the same NEXUS.md dozens of times.
   */
...
> = {
   ...
   * When exceeded, the result is saved to a file and Nexus receives a preview
