...
const DEFAULT_PREFIX = `You are Nexus Code, an AI assistant that helps developers with terminal-based coding tasks.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Nexus Code, an AI assistant that helps developers with terminal-based coding tasks, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Claude agent, built on the Claude Agent SDK.`
 ...
 * server verifies this token to confirm the request came from a real Nexus
