 ...
 *
 * This instruction provides guidance for Nexus's behavior when handling
 ...
 *   - How Nexus handles penetration testing and CTF requests
 *   - What security tools and techniques Nexus will assist with
 ...
 *
 * Nexus: Do not edit this file unless explicitly asked to do so by the user.
 */
